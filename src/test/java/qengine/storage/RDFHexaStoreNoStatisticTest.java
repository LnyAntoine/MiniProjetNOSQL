 ...
 */
public class RDFHexaStoreNoStatisticTest {
    ...
    public void testAddAllRDFAtoms() {
        RDFStorage store = new RDFHexaStoreNoStatistic();
        ...
        // Version collection
        store = new RDFHexaStoreNoStatistic();
    ...
    public void testMatchStarQueryHexastoreIntegraal() throws IOException {
        ...
        RDFHexaStoreNoStatistic store = new RDFHexaStoreNoStatistic();
