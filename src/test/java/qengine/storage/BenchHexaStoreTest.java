...
public class BenchHexaStoreTest {
    ...
    public void benchmarkMatchLittleSubset() {
        ...
        testForBenchmark.test(LITTLE_SUBSET_FILE_PATH ,DATA_500K_FILE,new RDFHexaStore());
    }
    @Test
    public void benchmarkMatchAverageSubset() {
        // Implémentation du benchmark à venir
        testForBenchmark.test(AVERAGE_SUBSET_FILE_PATH ,DATA_500K_FILE,new RDFHexaStore());

    }
    @Test
    public void benchmarkMatchBigSubset() {
        // Implémentation du benchmark à venir
        testForBenchmark.test(BIG_SUBSET_FILE_PATH ,DATA_500K_FILE,new RDFHexaStore());

    }
    @Test
    public void benchMarkMatchDegree1() {
        // Implémentation du benchmark à venir
        testForBenchmark.test(DEGREE_1_FILE_PATH ,DATA_500K_FILE,new RDFHexaStore());
    ...
    public void benchMarkMatchDegree3and4() {
        ...
        testForBenchmark.test(DEGREE_3_4_FILE_PATH,DATA_500K_FILE,new RDFHexaStore());
    }
