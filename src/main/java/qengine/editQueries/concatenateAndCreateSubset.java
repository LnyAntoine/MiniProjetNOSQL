...
public class concatenateAndCreateSubset {
    ...
    private static final int MAX_QUERIES_IN_LITTLE_SUBSET = 500;
    private static final int MAX_QUERIES_IN_AVERAGE_SUBSET = 1000;
    private static final int MAX_QUERIES_IN_BIG_SUBSET = 2000;
